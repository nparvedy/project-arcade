...
$bdd = new PDO('mysql:dbname=projet_arcarde;host=localhost', 'root', '');
// déplacez le $bdd ou plutot $pdo si vous preferez, moi , c'etait juste  plus simple
...
// a vous de voir si les directions pour header vous conviennent ou si vous preferez rediriger
// vers accueil ( adison, ça c'ecrit comme ça et pas acceuil, ok ;) )
?>
<html>
   <head>
...
<!-- avatar, j'ai créé un dossier et j'y ai mis le dossier avatars, voir ligne 90-->
<!-- si on se fout des erreurs a ce niveau la, effacez tous, je m'en fous -->
